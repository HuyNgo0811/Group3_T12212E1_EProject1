...
(function ($) {
    ...
    $(document).on('click', '.cmprBtn', function () {
        if ($(".cmprBtn").hasClass("active")) {
            ...
            $(".contentPop").append('<div class="col-sm-3 compareItemParent relPos">' + '<ul class="product">' + '<li class="relPos compHeader"><p class="w3-display-middle">Features</p></li>' + '<li>Name<br><br><br></li>' + '<li>Price</li>'  + '<li>machine</li>' + '<li>gas</li>' + '<li>technology</li>' + '<li>wattage</li>' + '</div>');
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                /*appending to div*/
                $(".contentPop").append(' <div class="col-sm-3 compareItemParent relPos">' + '<ul class="product">' + '<li class="compHeader"><img src="' + image + '" class="compareThumb"></li>' + '<li>' + title + '</li>' + '<li>' + $(product).data('price') + '</li>' + '<li>' + $(product).data('machine') + '</li>' + '<li>' + $(product).data('gas') + '</li>' + '<li>' + $(product).data('technology') + '</li>' + '<li>' + $(product).data('wattage') + '</li>' + '</ul>' + '</div>');
            }
        }
        $(".modPos").show();
    });
